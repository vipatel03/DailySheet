...
namespace DailySheet.data
{
    public static class IDataReaderExt
    {
        ...
        */
        ...
        {
            SqlDataReader sqlrdr = reader as SqlDataReader;
            if(sqlrdr == null)
            {
                throw new ArgumentException("GetSafeTimeSpan is only supported by SqlDataReader.");
            }
            return sqlrdr.GetSafeTimeSpan(ordinal);
        }
        ...
        public static TimeSpan? GetSafeTimeSpanNullable(this IDataReader reader, Int32 ordinal)
        {
            ...
            if (sqlrdr == null)
            {
                throw new ArgumentException("GetSafeTimeSpanNullable is only supported by SqlDataReader.");
            }
            return sqlrdr.GetSafeTimeSpanNullable(ordinal);
        }
